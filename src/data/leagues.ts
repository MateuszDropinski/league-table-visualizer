export const leagues = [
  ...
  { slug: 'bundesliga', logo: 'https://www.bundesliga.com/assets/logo/bundesliga_neg.svg', logoOnLight: false, name: 'Bundesliga', country: 'Germany', teamCount: 18 },
  ...
  { slug: 'ligue-1', logo: 'https://ligue1.com/images/Logo_Ligue1.webp', logoOnLight: false, name: 'Ligue 1', country: 'France', teamCount: 18 },
  { slug: 'ekstraklasa', logo: 'https://media.cms.ekstraklasa.org/images/originals/019f1d29-4986-7439-8e66-50bc7019bd1b.png?height=40&format=webp', logoOnLight: false, name: 'Ekstraklasa', country: 'Poland', teamCount: 18 },
] as const
